<h2><a href="https://www.geeksforgeeks.org/problems/majority-element-1587115620/1?_gl=1*ev9tu*_up*MQ..*_gs*MQ..&gclid=CjwKCAjwz_bABhAGEiwAm-P8Yb95JQ-8IHjs08zUbS8H5ErlDBOYLEJYUtgxQIV7C6KIcAI7QwBopBoCzucQAvD_BwE&gbraid=0AAAAAC9yBkAxZB6R0NKIOCNizjQl6jcp6">Majority Element</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong>. Find the <strong>majority element</strong> in the array. If no majority element exists, return <strong>-1</strong>.</span></p>
