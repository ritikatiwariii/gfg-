<h2><a href="https://www.geeksforgeeks.org/problems/k-largest-elements4206/1?_gl=1*1hfkt7p*_up*MQ..&gclid=CjwKCAjwz_bABhAGEiwAm-P8YW89b1MzrLMIvvrlwcedwfH9-9m_ucYnq40p-8z8LzJrH5srC1jvnxoC0jUQAvD_BwE&gbraid=0AAAAAC9yBkD70wdcONErvFYVgRu3jWNrN">k largest elements</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an array <strong>arr[]</strong> of positive integers and an integer <strong>k</strong>, Your task is to return <strong>k largest elements </strong>in decreasing order.&nbsp;</span></p>
